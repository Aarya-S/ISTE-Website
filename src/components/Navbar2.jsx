        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          {/* <div className="right-nav"> */}
            <Nav className="redirects-area">
              <Nav.Link href="/about" className="nav-redirects-custom">
                About
              </Nav.Link>
              <Nav.Link href="/team" className="nav-redirects-custom">
                Team
              </Nav.Link>
              <Nav.Link href="/gallery" className="nav-redirects-custom">
                Gallery
              </Nav.Link>
              <Nav.Link href="/blog" className="nav-redirects-custom">
                Blogs
              </Nav.Link>
              <Nav.Link href="/events" className="nav-redirects-custom">
                Events
              </Nav.Link>
              <Nav.Link
                href="/contact"
